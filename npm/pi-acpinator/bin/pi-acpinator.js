...
// @pi-acpinator/<platform>-<arch> package) and execs it, forwarding stdio so
// the ACP JSON-RPC stream passes through untouched.
const { spawnSync } = require("node:child_process");

const platform = process.platform;
const arch = process.arch;
const pkg = `@pi-acpinator/${platform}-${arch}`;
